...
void patch(int crc, unsigned char* buffer)
{
    ...
    sprintf( datFileName, "/Applications/snes4iphone.app/snesadvance.dat");
...
#ifdef __IPHONE__
	sprintf(str,"/Applications/snes4iphone.app/snesadvance.dat");
#else
...
#endif
{
  ...
  memset( &SA1, 0, sizeof( SSA1 ) );  
	...
	snesMenuOptions.showFps= (gp2x_fps_debug ? 1 : 0);
